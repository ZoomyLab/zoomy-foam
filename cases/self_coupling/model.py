...
The interface always exchanges the canonical project_2d_to_3d field set
[b, h, u, v, w, p]; project_3d_to_2d is the SWE identity.
"""
...
def write_headers():
    ...
    FoamSystemModelPrinter.write_code(
        ...
        project_3d_to_2d=model.project_3d_to_2d(),
    )
